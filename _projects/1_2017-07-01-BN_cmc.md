...
This project aims at validating **the effectiveness of BN** claimed by the authors, and we make several interesting observations:
...
In this work, we demonstrate the effectiveness of BN by comprehensive experiments and also investigate the underlying reasons, in the theoretical point of view, that why batch normalization works so well.
